...
load("/home/rj/4TB/PORTABLE_DATA/RDATA/FCD_met/FCD_sesame_February2026.Rdata")
...
# most important asi it is for EPIC
...
##
save(EPICbeta, EPICM, SAMPLES, file="/home/rj/4TB/PORTABLE_DATA/RDATA/FCD_met/FCD_sesame_February2026_filteredprobes.Rdata", compress=TRUE)
...
# fwrite(SAMPLES, file = "/home/rj/4TB/PORTABLE_DATA/RDATA/FCD_met/FCD_EPIC_SAMPLES.tsv", sep = "\t")
# fwrite(EPICbetaDT, file = "/home/rj/4TB/PORTABLE_DATA/RDATA/FCD_met/FCD_sesame_BETAvalues_October2025_filteredprobes.tsv", sep = "\t")
# fwrite(EPICMDT, file = "/home/rj/4TB/PORTABLE_DATA/RDATA/FCD_met/FCD_sesame_Mvalues_October2025_filteredprobes.tsv", sep = "\t")
